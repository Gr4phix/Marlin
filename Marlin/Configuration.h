...
#define ANYCUBIC_KOSSEL_ENABLE_BED 1 //ist ja eigentlich aus Alu...
...
#define STRING_CONFIG_H_AUTHOR "Florian Schuster" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Drucker booted..." // will be shown during bootup in line 1
